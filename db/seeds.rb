...
furniture7 = Furniture.create(name: "shelf", room: "Dining Room", store: "Blu Dot", user_id: User.find_by(username: "Nicole").id, photo: {io: File.open("#{Rails.root}/public/images/sectional.png"), filename: "sectional.png"})
